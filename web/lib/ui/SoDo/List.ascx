<%@ Control Language="C#" AutoEventWireup="true" CodeFile="List.ascx.cs" Inherits="lib_ui_SoDo_List" %>
<%@ Register Src="~/lib/ui/SoDo/templates/Item.ascx" TagPrefix="uc1" TagName="Item" %>
        ...
        <div class="panel-body" role="form">
            <div class="form-inline">
                <div class="form-group pull-left">
                    <a href="/lib/pages/SoDo/Add.aspx" class="btn btn-primary">Thêm</a>      
                    <a href="/lib/pages/SoDo/" class="btn btn-success">
