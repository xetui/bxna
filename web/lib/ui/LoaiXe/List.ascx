<%@ Control Language="C#" AutoEventWireup="true" CodeFile="List.ascx.cs" Inherits="lib_ui_LoaiXe_List" %>
<%@ Register Src="~/lib/ui/LoaiXe/templates/Item.ascx" TagPrefix="uc1" TagName="Item" %>
        ...
        <div class="panel-body" role="form">
            <div class="form-inline">
                <div class="form-group pull-left">
                    <a href="/lib/pages/LoaiXe/Add.aspx" class="btn btn-primary">Thêm</a>      
                    <a href="/lib/pages/LoaiXe/" class="btn btn-success">
