<%@ Control Language="C#" AutoEventWireup="true" CodeFile="List.ascx.cs" Inherits="lib_ui_Tuyen_List" %>
<%@ Register Src="~/lib/ui/Tuyen/templates/Item.ascx" TagPrefix="uc1" TagName="Item" %>
        ...
        <div class="panel-body" role="form">
            <div class="form-inline">
                <div class="form-group pull-left">
                    <a href="/lib/pages/Tuyen/Add.aspx" class="btn btn-primary">Thêm</a>      
                    <a href="/lib/pages/Tuyen/" class="btn btn-success">
