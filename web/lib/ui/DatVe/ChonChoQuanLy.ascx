<%@ Control Language="C#" AutoEventWireup="true" CodeFile="ChonChoQuanLy.ascx.cs" Inherits="lib_ui_DatVe_ChonChoQuanLy" %>
<%@ Import Namespace="linh.common" %>
<div class="datVe-quanLyChonGhe">
    <div class="row">
    ...
    <hr/>
        <div class="datVe-chonGhePnl-btnDatVePnl">
            <button 
                ...
                class="btn btn-block btn-lg btn-danger btnQuanLyChonGhe">
                ĐẶT VÉ
            </button>
