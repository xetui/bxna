<%@ Control Language="C#" AutoEventWireup="true" CodeFile="List.ascx.cs" Inherits="lib_ui_LoaiBieuDo_List" %>
<%@ Register Src="~/lib/ui/LoaiBieuDo/templates/Item.ascx" TagPrefix="uc1" TagName="Item" %>
        ...
        <div class="panel-body" role="form">
            <div class="form-inline">
                <div class="form-group pull-left">
                    <a href="/lib/pages/LoaiBieuDo/Add.aspx" class="btn btn-primary">Thêm</a>      
                    <a href="/lib/pages/LoaiBieuDo/" class="btn btn-success">
