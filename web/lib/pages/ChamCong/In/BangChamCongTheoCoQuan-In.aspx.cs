...
public partial class lib_pages_ChamCong_In_BangChamCongTheoCoQuan_In : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (string.IsNullOrEmpty(tuyenId)) tuyenId = "5";
        if (string.IsNullOrEmpty(thang)) thang = string.Format("{0:MM}/{0:yyyy}", DateTime.Now);
